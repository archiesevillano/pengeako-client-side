...
import { FacebookAuthProvider, getAuth, GoogleAuthProvider, TwitterAuthProvider, OAuthProvider } from "firebase/auth";
...
export const microsoft_provider = new OAuthProvider();
